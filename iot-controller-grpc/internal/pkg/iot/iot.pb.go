...
type IotRequest struct {
	...
	Led *Led `protobuf:"bytes,1,opt,name=led,proto3" json:"led,omitempty"`
}
...
func (x *IotResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IotResponse) ProtoMessage() {}

func (x *IotResponse) ProtoReflect() protoreflect.Message {
	mi := &file_iot_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IotResponse.ProtoReflect.Descriptor instead.
func (*IotResponse) Descriptor() ([]byte, []int) {
	return file_iot_proto_rawDescGZIP(), []int{2}
}

func (x *IotResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_iot_proto_rawDesc = []byte{
	...
	0x22, 0x2f, 0x0a, 0x03, 0x4c, 0x65, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x70, 0x69, 0x6e, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x70, 0x69, 0x6e, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x63, 0x74,
	0x69, 0x76, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76,
	0x65, 0x22, 0x28, 0x0a, 0x0a, 0x49, 0x6f, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x1a, 0x0a, 0x03, 0x6c, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x69,
	0x6f, 0x74, 0x2e, 0x4c, 0x65, 0x64, 0x52, 0x03, 0x6c, 0x65, 0x64, 0x22, 0x25, 0x0a, 0x0b, 0x49,
	...
	0x6c, 0x74, 0x32, 0x3d, 0x0a, 0x0a, 0x49, 0x6f, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x2f, 0x0a, 0x0a, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x49, 0x6f, 0x74, 0x12, 0x0f,
	0x2e, 0x69, 0x6f, 0x74, 0x2e, 0x49, 0x6f, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x10, 0x2e, 0x69, 0x6f, 0x74, 0x2e, 0x49, 0x6f, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x69, 0x6f, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_iot_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_iot_proto_goTypes = []interface{}{
	(*Led)(nil),         // 0: iot.Led
	(*IotRequest)(nil),  // 1: iot.IotRequest
	(*IotResponse)(nil), // 2: iot.IotResponse
}
var file_iot_proto_depIdxs = []int32{
	0, // 0: iot.IotRequest.led:type_name -> iot.Led
	1, // 1: iot.IotService.ProcessIot:input_type -> iot.IotRequest
	2, // 2: iot.IotService.ProcessIot:output_type -> iot.IotResponse
